...
.back{
padding:12px 18px;background:#e2e8f0;
...
<div class="sub">Sistem otomatis rekomendasi vaksin berdasarkan umur anak</div>
</div>

<a href="index.php?page=imunisasi" class="back">← Kembali</a>
</div>

<form method="POST" action="modules/imunisasi/simpan.php" class="form-box">
...
<input type="text" name="jenis_imunisasi" id="jenis" required>
</div>
...
Pilih anak terlebih dahulu untuk melihat rekomendasi imunisasi.
</div>
</div>
