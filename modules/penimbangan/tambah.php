...
<div class="sub">Input hasil timbang bayi / balita</div>
</div>

<a href="index.php?page=penimbangan" class="back">← Kembali</a>
</div>

<form method="POST" action="modules/penimbangan/simpan.php" class="form-box">
...
<input type="number" name="umur_bulan" id="umur_bulan" readonly>
</div>

<div class="group">
<label>Berat Badan (Kg)</label>
<input type="number" step="0.01" name="berat" id="berat" required onkeyup="hitungGizi()">
</div>

<div class="group">
<label>Tinggi Badan (Cm)</label>
<input type="number" step="0.01" name="tinggi">
</div>
...
<input type="text" name="status_gizi" id="status_gizi" readonly>
</div>
...
let umur = opt.getAttribute('data-umur');
...
document.getElementById('status_gizi').value = hasil;
